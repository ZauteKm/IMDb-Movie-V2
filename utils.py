...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open(f"plugins/voicechat/choose/rrc.png")
    ...
    font = ImageFont.truetype("plugins/voicechat/choose/Roboto-Light.ttf", 55)
    font2 = ImageFont.truetype("plugins/voicechat/choose/finalfont.ttf", 65)
    draw.text(
        (20, 630),
        f"{title[:25]}...",
        fill="White",
