...
from plugins.voicechat.handlers import skip_current_song, skip_item
from plugins.voicechat.queues import QUEUE, clear_queue
...
@Client.on_message(filters.command(['end', 'stop']) & filters.user(ADMINS))
